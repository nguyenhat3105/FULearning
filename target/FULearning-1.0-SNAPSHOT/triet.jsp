    ...
    <div class="row thongtin" style="margin: 100px 0px">
        <div class="col-md-8" style="background:#fdfdfd; border-radius:12px; padding:30px; box-shadow:0 4px 16px rgba(0, 0, 0, 0.08); max-width:800px; font-family:'Segoe UI', sans-serif; line-height:1.6;">
            ...
            <p style="font-size:16px; color:#666; margin-bottom:25px;">
                <i class="fas fa-user-tie"></i> Technical Mentor
            </p>
            ...
            <p style="text-align:justify; font-size:15px; color:#444;">
                Mentor Nguyễn Minh Triết là sinh viên năm nhất (kỳ 2) tại Đại học FPT, hiện đang theo học chuyên 
                ngành Công nghệ Thông tin. Với kinh nghiệm 3 kỳ học liên tiếp môn PRF cùng sự chỉ dẫn sát sao 
                từ cô Thuyền – người thầy hướng dẫn tâm huyết, mentor Triết sở hữu nền tảng kiến thức vững chắc
                và tư duy lập trình logic. Phong cách giảng dạy gần gũi, thẳng thắn nhưng dễ hiểu giúp học viên 
                nắm bắt bài nhanh chóng và tự tin áp dụng vào các bài toán thực tế.
            </p>
            ...
            <ul style="list-style:none; padding-left:0; font-size:15px; color:#444;">
                <li style="margin-bottom:6px;"><i class="fas fa-star" style="color:#ffc107; margin-right:8px;"></i>Đệ ruột cô Thuyền</li>
                <li style="margin-bottom:6px;"><i class="fas fa-star" style="color:#ffc107; margin-right:8px;"></i>Top 1000 SV Kỳ Spring 2025</li>
                <li style="margin-bottom:6px;"><i class="fas fa-star" style="color:#ffc107; margin-right:8px;"></i>Top 999 SE Quy Nhơn</li>
            </ul>
            ...
            <div class="khoahoc">
                ...
                <div class="row khoahoc_csd" style="margin-top: 50px; background-color: #eaeaea; padding:10px 0px; border-radius: 15px">
                    <div class="col-md-3 img_khoahoc">
                        <img src="image/csd_img.jpg" alt="alt" style="border-radius: 15px"/>
                    </div>
                    <div class="col-md-6 thongtin_khoahoc">
                        <h5 style="margin-bottom: 40px">PRF192 - Cơ sở lập trình</h5>
                ...
                <div class="row khoahoc_csd" style="margin-top: 20px; background-color: #eaeaea; padding:10px 0px; border-radius: 15px">
                    <div class="col-md-3 img_khoahoc">
                        <img src="image/pro_img.jpg" alt="alt" style="border-radius: 15px"/>
                    </div>
                    <div class="col-md-6 thongtin_khoahoc">
                        <h5 style="margin-bottom: 40px">PRO192 - Lập trình hướng đối tượng với Java</h5>
                        <span class="rating">4.5 ★</span><br>
                        <span class="category"><i class="icon bi bi-person"></i>Software Engineering</span>
                    </div>
                    <div class="col-md-3 gia_khoahoc">
        ...
        <div class="col-md-4 anh" style="margin-left: 50px">
            <div>
                ...
                <div class="link" style="text-align: center; margin-top: 40px">
                    <a href="https://www.facebook.com/minh.triet.650968" class="social-link" target="_blank">
                        <i class="bi bi-facebook"></i> https://www.facebook.com/minh.triet.650968
                    </a>
                    <br>
                    <a href="https://www.instagram.com/lil.scyboi._og/" class="social-link youtube" target="_blank">
                        <i class="bi bi-instagram"></i> https://www.instagram.com/lil.scyboi._og/
                    </a>
                </div>


                <a href="minh.jsp" class="muiten"><i class="fas fa-arrow-right"></i></a>
            </div>
