    ...
    <div class="row thongtin" style="margin:100px 0px;">
        <div class="col-md-8" style="background:#fdfdfd; border-radius:12px; padding:30px; box-shadow:0 4px 16px rgba(0, 0, 0, 0.08); max-width:800px; font-family:'Segoe UI', sans-serif; line-height:1.6;">
            ...
            <p style="font-size:16px; color:#666; margin-bottom:25px;">
                <i class="fas fa-user-tie"></i> Language Team Leader
            </p>
            ...
            <p style="text-align:justify; font-size:15px; color:#444;">
                Mentor Nguyễn Quang Minh là sinh viên ngành Công nghệ Thông tin, nổi bật với năng lực 
                ngôn ngữ đa dạng và tư duy phân tích sắc bén. Là người Việt gốc Mỹ, mentor Minh có nền 
                tảng song ngữ vững chắc, đặc biệt thành thạo tiếng Anh và tiếng Nhật. Sự kết hợp giữa khả 
                năng ngôn ngữ và kỹ thuật giúp mentor truyền đạt kiến thức lập trình một cách dễ hiểu, 
                chuẩn xác, đồng thời tạo cầu nối hiệu quả giữa học thuật và thực tiễn quốc tế. Phong thái
                thân thiện, nhiệt tình và cầu tiến là điểm nổi bật giúp học viên cảm thấy gần gũi, tự tin 
                trong quá trình học.
            </p>
            ...
            <ul style="list-style:none; padding-left:0; font-size:15px; color:#444;">
                <li style="margin-bottom:6px;"><i class="fas fa-star" style="color:#ffc107; margin-right:8px;"></i>Người Việt gốc Mỹ</li>
                <li style="margin-bottom:6px;"><i class="fas fa-star" style="color:#ffc107; margin-right:8px;"></i>Top 100 SVSX Kỳ Spring 2025</li>
                <li style="margin-bottom:6px;"><i class="fas fa-star" style="color:#ffc107; margin-right:8px;"></i>Top 1 JPD Quy Nhơn</li>
            </ul>
            ...
            <div class="khoahoc">
                ...
                <div class="row khoahoc_csd" style="margin-top: 50px; background-color: #eaeaea; padding:10px 0px; border-radius: 15px">
                    ...
                    <div class="col-md-6 thongtin_khoahoc">
                        <h5 style="margin-bottom: 40px">JPD113 - Tiếng Nhật sơ cấp 1-A1.1</h5>
                        <span class="rating">4.5 ★</span><br>
                        <span class="category"><i class="icon bi bi-person"></i>Language</span>
                    </div>
                ...
                <div class="row khoahoc_csd" style="margin-top: 20px; background-color: #eaeaea; padding:10px 0px; border-radius: 15px">
                    ...
                    <div class="col-md-6 thongtin_khoahoc">
                        <h5 style="margin-bottom: 40px">JPD123 - Tiếng Nhật sơ cấp 1-A1.2</h5>
                        <span class="rating">4.5 ★</span><br>
                        <span class="category"><i class="icon bi bi-person"></i>Language</span>
                    </div>
                    <div class="col-md-3 gia_khoahoc">
                ...
                <div class="row khoahoc_csd" style="margin-top: 20px; background-color: #eaeaea; padding:10px 0px; border-radius: 15px">
                    ...
                    <div class="col-md-6 thongtin_khoahoc">
                        <h5 style="margin-bottom: 40px">JPD133 - Tiếng Nhật sơ cấp 1-A1.3</h5>
                        <span class="rating">4.5 ★</span><br>
                        <span class="category"><i class="icon bi bi-person"></i>Language</span>
                    </div>
                    <div class="col-md-3 gia_khoahoc">
        ...
        <div class="col-md-4 anh" style="margin-left: 50px">
            <div>
                ...
                <div class="link" style="text-align: center; margin-top: 40px">
                    <a href="https://www.facebook.com/nguyen.minh.961632" class="social-link" target="_blank">
                        <i class="bi bi-facebook"></i> https://www.facebook.com/nguyen.minh.961632
                    </a>
                    <br>
                ...
                <a href="tuan.jsp" class="muiten"><i class="fas fa-arrow-right"></i></a>
            </div>
