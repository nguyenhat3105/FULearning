    ...
    <div class="row thongtin" style="margin:100px 0px;">
        <div class="col-md-8" style="background:#fdfdfd; border-radius:12px; padding:30px; box-shadow:0 4px 16px rgba(0, 0, 0, 0.08); max-width:800px; font-family:'Segoe UI', sans-serif; line-height:1.6;">
            ...
            <p style="font-size:16px; color:#666; margin-bottom:25px;">
                <i class="fas fa-user-tie"></i> Technical Team Leader
            </p>
            ...
            <p style="text-align:justify; font-size:15px; color:#444;">
                Mentor Hồ Lê Quốc Khánh là sinh viên năm hai (kỳ 4) tại Đại học FPT, hiện đang theo học chuyên ngành Công nghệ Thông tin. 
                Với thế mạnh nổi bật ở các môn lập trình và kỹ năng phát triển giao diện người dùng (Front-end), mentor mang đến góc nhìn 
                thực tiễn, trẻ trung và gần gũi, giúp học viên dễ dàng tiếp cận kiến thức và ứng dụng vào thực tế.
            </p>
            ...
            <ul style="list-style:none; padding-left:0; font-size:15px; color:#444;">
                <li style="margin-bottom:6px;"><i class="fas fa-star" style="color:#ffc107; margin-right:8px;"></i>Top 2 FRunner</li>
            ...
            <div class="khoahoc">
                ...
                <div class="row khoahoc_csd" style="margin-top: 50px; background-color: #eaeaea; padding:10px 0px; border-radius: 15px">
                    ...
                    <div class="col-md-6 thongtin_khoahoc">
                        <h5 style="margin-bottom: 40px">CSD201 - Cấu trúc dữ liệu và giải thuật</h5>
                ...
                <div class="row khoahoc_csd" style="margin-top: 20px; background-color: #eaeaea; padding:10px 0px; border-radius: 15px">
                    ...
                    <div class="col-md-6 thongtin_khoahoc">
                        <h5 style="margin-bottom: 40px">DBI202 - Các hệ cơ sở dữ liệu</h5>
                        <span class="rating">4.5 ★</span><br>
                        <span class="category"><i class="icon bi bi-person"></i>Software Engineering</span>
                    </div>
                    <div class="col-md-3 gia_khoahoc">
        ...
        <div class="col-md-4 anh" style="margin-left: 50px">
            <div>
                <img src="image/khanh_1.jpg">
                <div class="link" style="text-align: center; margin-top: 40px">
                    <a href="https://www.facebook.com/khanhho291" class="social-link" target="_blank">
                        <i class="bi bi-facebook"></i> https://www.facebook.com/khanhho291
                    </a>
                    <br>
                ...
                <a href="triet.jsp" class="muiten"><i class="fas fa-arrow-right"></i></a>
            </div>
