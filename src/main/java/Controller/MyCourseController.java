...
public class MyCourseController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Course> listCourse = enro.getCourseByStudentId(student.getId());
        List<Enrollment> enrollments = enro.getEnrollmentsByStudentId(student.getId());
        
        Long totalCourse = enro.countCourseByStudentId(student.getId());

        // Gửi tới JSP
        request.setAttribute("student", student);
        request.setAttribute("totalCourse", totalCourse);
        request.setAttribute("listCourse", listCourse);
        request.setAttribute("listEnrollment", enrollments);
