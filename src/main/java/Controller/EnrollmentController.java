 ...
 * @author CONG NHAT
 */
@WebServlet(name = "EnrollmentController", urlPatterns = {"/EnrollmentController"})
public class EnrollmentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("KhoaHocController?category=" + category).forward(request, response);
